    ...
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            try
            {
                ...
                //Возвращаемое значение не предоставляет интереса.
                //НО есть необходимость выполнить некоторые действия только после завершения всех!!! задач асинхронного метода -
                ...
                //#4.1. Возвращаемое значение имеет место быть, но в главной программе он не важно/не используется
                ...
                //#4.2. Возвращаемое значение имеет место быть, в главной программе он важно/используется
